//
//  SearchExperiencesService.swift
//  aroundEgypt
//
...
class SearchExperiencesService {
    
    var cancellable = Set<AnyCancellable>()
    
    func getExperiencesData(url: String) -> Future<SearchExperiencesModel, ExperiencesError>{
        ...
        return Future { promise in
            ...
            URLSession.shared.dataTaskPublisher(for: url)
                ...
                .decode(type: SearchExperiencesModel.self, decoder: JSONDecoder())
                .sink{ completion in
