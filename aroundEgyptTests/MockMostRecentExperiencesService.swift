...
class MockMostRecentExperiencesService: MostRecentExperiencesService {
    var mockResponse: MostRecentExperiencesModel?
    var mockError: ExperiencesError?

    override func getExperiencesData(url: String) -> Future<MostRecentExperiencesModel, ExperiencesError> {
